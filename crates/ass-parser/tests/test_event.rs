...
fn test_parse_dialogue_line() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,Hello World").unwrap();
...
fn test_parse_comment_line() {
    let e = Event::parse_from_line(EventType::Comment, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,Comment text").unwrap();
    assert!(!e.is_dialogue());
...
fn test_event_with_override_tags() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,{\\pos(100,200)}Positioned text").unwrap();
...
fn test_event_with_multiple_tags() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,{\\b1\\i1\\pos(100,200)}Styled").unwrap();
    assert!(e.has_override_tags());
...
fn test_event_karaoke_detection() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,{\\kf50}Ka{\\kf100}ra").unwrap();
    assert!(e.has_karaoke() || e.override_tags.iter().any(|t| matches!(t, OverrideTag::Karaoke { .. })));
}

#[test]
fn test_event_no_override_tags() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,Plain text").unwrap();
    assert!(!e.has_override_tags());
}

#[test]
fn test_event_empty_text() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,").unwrap();
    assert_eq!(e.text, "");
}

#[test]
fn test_event_with_style() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Sign,,0,0,0,,Text with sign style").unwrap();
...
fn test_event_move_tag() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,{\\move(100,200,300,400)}Moved").unwrap();
    assert!(e.has_override_tags());
    match &e.override_tags[0] {
...
fn test_event_fade_tag() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,{\\fad(500,500)}Faded").unwrap();
    assert!(e.has_override_tags());
    match &e.override_tags[0] {
...
fn test_event_font_tag() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,{\\fnImpact}Changed font").unwrap();
    match &e.override_tags[0] {
...
fn test_event_fontsize_tag() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,{\\fs36}Bigger").unwrap();
    match &e.override_tags[0] {
...
fn test_event_alignment_tag() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,0,0,0,,{\\an8}Top center").unwrap();
    match &e.override_tags[0] {
...
fn test_event_margins() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:01.00,0:00:05.00,Default,,50,100,25,0,,Custom margins").unwrap();
...
fn test_duration_saturating() {
    let e = Event::parse_from_line(EventType::Dialogue, "0,0:00:05.00,0:00:01.00,Default,,0,0,0,,Invalid duration").unwrap();
