...
pub fn parse(s: &str) -> Option<OverrideTag> {
    ...
    if s.starts_with("writing_mode(")
        && let Ok(v) = super::util::paren_body(s, "writing_mode(").parse::<u8>()
    {
